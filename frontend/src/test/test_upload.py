...
class TestUpload():
  ...
  def test_o(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".container > div > input").send_keys(os.getcwd() + "/frontend/src/test/testing_docs/excel/input_standardExcel-Template.xlsx")
