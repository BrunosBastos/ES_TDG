...
class TestTestfill():
    ...
    def test_testfill(self):
        ...
        path = "/frontend/src/test/testing_docs/excel/input_standardExcel-Data.json"
        self.driver.find_element(By.CSS_SELECTOR, ".MuiButton-root > input").send_keys(os.getcwd()+path)
